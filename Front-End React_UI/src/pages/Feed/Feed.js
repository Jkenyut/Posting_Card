...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    //     console.log("post socket", data.post);
  ...
  finishEditHandler = (postData) => {
    ...
    fetch("http://localhost:8080/post-image", {
      ...
      .then((fileResData) => {
        ...
        let qraphqQuery = {
          query: `
      mutation craateNewPost($title:String!, $content:String!,$imageUrl:String!){
        ...
        return fetch("http://localhost:8080/graphql", {
          method: "POST",
          body: JSON.stringify(qraphqQuery),
          headers: {
            Authorization: "Bearer " + this.props.token,
            "Content-Type": "application/json",
          },
